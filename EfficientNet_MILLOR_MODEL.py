...
def initialize_model(num_classes):
    ...
    # model.fc = nn.Linear(num_ftrs, num_classes)  # Reemplaza la capa fully connected para el número de clases
...
# Train and evaluate
model_feature, histFeature, lossesFeature = mn.train_model(model, loaded_dataloader, criterion, optimizer_ft, num_epochs=num_epochs, change_lr=True, learning_rate=lr)
gt,pr=mn.predict(model_feature,loaded_dataloader,criterion)

torch.save(model_feature, 'EfficientNet_1_Aina.pt')
